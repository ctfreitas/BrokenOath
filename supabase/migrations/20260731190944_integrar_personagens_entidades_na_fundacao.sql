...
BEGIN
    ...
    -- =====================================================
    -- Localiza título e cargo iniciais
    -- =====================================================
    ...
    SELECT id
    INTO v_cargo_governador_id
    FROM public.cargo_tipos
    WHERE nome = 'Governador'
    LIMIT 1;

    IF v_cargo_governador_id IS NULL THEN
        RAISE EXCEPTION 'CARGO_GOVERNADOR_NAO_ENCONTRADO';
    END IF;
    ...
    -- =====================================================
    -- Cria o cargo de Governador da nova cidade
    -- =====================================================
    ...
    VALUES (
        v_personagem_id,
        v_cargo_governador_id,
        v_entidade_cidade_id,
        now(),
        true
    );
