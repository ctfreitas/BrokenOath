...
CREATE TABLE IF NOT EXISTS "public"."cidade_governanca" (
    "id" bigint NOT NULL,
    "cidade_id" bigint NOT NULL,
    "tipo_governante" "text" NOT NULL,
    "governante_user_id" "uuid",
    "nome_governante_npc" "text",
    "titulo_governante" "text" NOT NULL,
    "nivel_governante" integer DEFAULT 1 NOT NULL,
    "lealdade" integer DEFAULT 50 NOT NULL,
    "autonomia" integer DEFAULT 50 NOT NULL,
    "inicio_governo" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fim_governo" timestamp with time zone,
    "ativo" boolean DEFAULT true NOT NULL,
    CONSTRAINT "cidade_governanca_autonomia_check" CHECK ((("autonomia" >= 0) AND ("autonomia" <= 100))),
    CONSTRAINT "cidade_governanca_governante_valido" CHECK (((("tipo_governante" = 'jogador'::"text") AND ("governante_user_id" IS NOT NULL) AND ("nome_governante_npc" IS NULL)) OR (("tipo_governante" = 'npc'::"text") AND ("governante_user_id" IS NULL) AND ("nome_governante_npc" IS NOT NULL)))),
    CONSTRAINT "cidade_governanca_lealdade_check" CHECK ((("lealdade" >= 0) AND ("lealdade" <= 100))),
    CONSTRAINT "cidade_governanca_nivel_governante_check" CHECK (("nivel_governante" >= 0)),
    CONSTRAINT "cidade_governanca_periodo_valido" CHECK ((("fim_governo" IS NULL) OR ("fim_governo" >= "inicio_governo"))),
    CONSTRAINT "cidade_governanca_tipo_governante_check" CHECK (("tipo_governante" = ANY (ARRAY['npc'::"text", 'jogador'::"text"])))
);


ALTER TABLE "public"."cidade_governanca" OWNER TO "postgres";


ALTER TABLE "public"."cidade_governanca" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."cidade_governanca_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."cidades" (
    ...
    CONSTRAINT "cidades_usuario_obrigatorio_para_jogador" CHECK (((("tipo_entidade")::"text" <> 'jogador'::"text") OR ("user_id" IS NOT NULL))),
...
CREATE TABLE IF NOT EXISTS "public"."cidade_subordinacao" (
    "id" bigint NOT NULL,
    "cidade_id" bigint NOT NULL,
    "tipo_suserano" "text" DEFAULT 'independente'::"text" NOT NULL,
    "suserano_user_id" "uuid",
    "inicio_subordinacao" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fim_subordinacao" timestamp with time zone,
    "motivo" "text",
    "ativo" boolean DEFAULT true NOT NULL,
    CONSTRAINT "cidade_subordinacao_periodo_valido" CHECK ((("fim_subordinacao" IS NULL) OR ("fim_subordinacao" >= "inicio_subordinacao"))),
    CONSTRAINT "cidade_subordinacao_suserano_valido" CHECK (((("tipo_suserano" = 'jogador'::"text") AND ("suserano_user_id" IS NOT NULL)) OR (("tipo_suserano" = ANY (ARRAY['reino'::"text", 'independente'::"text"])) AND ("suserano_user_id" IS NULL)))),
    CONSTRAINT "cidade_subordinacao_tipo_suserano_check" CHECK (("tipo_suserano" = ANY (ARRAY['reino'::"text", 'jogador'::"text", 'independente'::"text"])))
);


ALTER TABLE "public"."cidade_subordinacao" OWNER TO "postgres";


ALTER TABLE "public"."cidade_subordinacao" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."cidade_subordinacao_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."cidade_governanca"
    ADD CONSTRAINT "cidade_governanca_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."cidade_subordinacao"
    ADD CONSTRAINT "cidade_subordinacao_pkey" PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX "cidade_governanca_uma_ativa_por_cidade" ON "public"."cidade_governanca" USING "btree" ("cidade_id") WHERE ("ativo" = true);



CREATE UNIQUE INDEX "cidade_subordinacao_uma_ativa_por_cidade" ON "public"."cidade_subordinacao" USING "btree" ("cidade_id") WHERE ("ativo" = true);
...
ALTER TABLE ONLY "public"."cidade_governanca"
    ADD CONSTRAINT "cidade_governanca_cidade_id_fkey" FOREIGN KEY ("cidade_id") REFERENCES "public"."cidades"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."cidade_governanca"
    ADD CONSTRAINT "cidade_governanca_governante_user_id_fkey" FOREIGN KEY ("governante_user_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."cidade_subordinacao"
    ADD CONSTRAINT "cidade_subordinacao_cidade_id_fkey" FOREIGN KEY ("cidade_id") REFERENCES "public"."cidades"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."cidade_subordinacao"
    ADD CONSTRAINT "cidade_subordinacao_suserano_user_id_fkey" FOREIGN KEY ("suserano_user_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
CREATE POLICY "authenticated_can_read_cidade_governanca" ON "public"."cidade_governanca" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "authenticated_can_read_cidade_subordinacao" ON "public"."cidade_subordinacao" FOR SELECT TO "authenticated" USING (true);
...
ALTER TABLE "public"."cidade_subordinacao" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."cidade_governanca" TO "anon";
GRANT ALL ON TABLE "public"."cidade_governanca" TO "authenticated";
GRANT ALL ON TABLE "public"."cidade_governanca" TO "service_role";



GRANT ALL ON SEQUENCE "public"."cidade_governanca_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cidade_governanca_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cidade_governanca_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."cidade_subordinacao" TO "anon";
GRANT ALL ON TABLE "public"."cidade_subordinacao" TO "authenticated";
GRANT ALL ON TABLE "public"."cidade_subordinacao" TO "service_role";



GRANT ALL ON SEQUENCE "public"."cidade_subordinacao_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cidade_subordinacao_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cidade_subordinacao_id_seq" TO "service_role";
